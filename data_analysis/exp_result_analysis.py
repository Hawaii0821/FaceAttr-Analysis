...
if __name__ == "__main__":
    eval_acc_csv = '../result/v4-Resnet101-eval_accuracy.csv'
    eval_acc_df = pd.read_csv(eval_acc_csv)
    show_eval_accuracy(eval_acc_df, eval_acc_csv.replace('.csv', '.png'))
    
    # print("ok!")
    test_acc_csv = '../result/v4-Resnet101-test_accuracy.csv'
    ...
    loss_csv = '../result/v4-Resnet101-losses.csv'
    loss_df = pd.read_csv(loss_csv)
    show_loss(loss_df, loss_csv.replace('.csv', '.png'))
    
    matrix = '../result/v4-Resnet101-confusion_matrix.csv'
